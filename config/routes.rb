Chowdy::Application.routes.draw do
  ...
  post 'customers/submit_photo' => 'customers#photo_submission', as: 'meal_photo_submission'
  ...
  get 'customers/:id/olrestart/:reminder_id' => 'customers#one_link_restart', as: 'one_link_restart'
  get 'customers/:id/add_to_do_not_email/:reminder_id' => 'customers#add_to_do_not_email', as: 'add_to_do_not_email'
  ...
  get 'menu/:id/show_nutritional_info' => 'menus#show_nutritional_info', as: 'show_nutritional_info'
