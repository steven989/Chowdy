class CustomerMailer < ActionMailer::Base
  ...
  default from: SystemSetting.where(setting:"admin",setting_attribute:"admin_email").take.nil? ? "" : SystemSetting.where(setting:"admin",setting_attribute:"admin_email").take.setting_value
