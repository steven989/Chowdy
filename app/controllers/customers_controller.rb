...
protect_from_forgery :except => :payment
    ...
    def create #create customer account through Stripe webhook
        ...
        #         puts error.message
        #         puts '---------------------------------------------------' 
        #         CustomerMailer.delay.rescued_error(customer,error.message)
        #     end
        ...
        #                         CustomerMailer.delay.duplicate_signup_email(first_name_email,customer_email)
        #                     end
        #                 end
        ...
        #             CustomerMailer.delay.confirmation_email(customer,hub_email,first_name_email,start_date_email,customer_email,meal_per_week,email_monday_regular,email_thursday_regular,email_monday_green,email_thursday_green,referral_name_email)
        #         end
        ...
        #             CustomerMailer.delay.manual_check_for_signup(customer,manual_checks)
        #         end
        # end
