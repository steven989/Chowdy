class AdminActionsController < ApplicationController
    ...
    def customer_sheet  
        ...
        @salad_bowl_1_monday = Menu.where(production_day:production_day_sunday, meal_type:"Salad Bowl 1").take.meal_name unless Menu.where(production_day:production_day_sunday, meal_type:"Salad Bowl 1").blank?
        @salad_bowl_1_thursday = Menu.where(production_day:production_day_wednesday, meal_type:"Salad Bowl 1").take.meal_name unless Menu.where(production_day:production_day_wednesday, meal_type:"Salad Bowl 1").blank?
        @salad_bowl_2_monday = Menu.where(production_day:production_day_sunday, meal_type:"Salad Bowl 2").take.meal_name unless Menu.where(production_day:production_day_sunday, meal_type:"Salad Bowl 2").blank?
        @salad_bowl_2_thursday = Menu.where(production_day:production_day_wednesday, meal_type:"Salad Bowl 2").take.meal_name unless Menu.where(production_day:production_day_wednesday, meal_type:"Salad Bowl 2").blank?
        @diet_monday = Menu.where(production_day:production_day_sunday, meal_type:"Diet").take.meal_name unless Menu.where(production_day:production_day_sunday, meal_type:"Diet").blank?
        @diet_thursday = Menu.where(production_day:production_day_wednesday, meal_type:"Diet").take.meal_name unless Menu.where(production_day:production_day_wednesday, meal_type:"Diet").blank?
        @chefs_special_monday = Menu.where(production_day:production_day_sunday, meal_type:"Chef's Special").take.meal_name unless Menu.where(production_day:production_day_sunday, meal_type:"Chef's Special").blank?
        @chefs_special_thursday = Menu.where(production_day:production_day_wednesday, meal_type:"Chef's Special").take.meal_name unless Menu.where(production_day:production_day_wednesday, meal_type:"Chef's Special").blank?
    ...
    def next_week_breakdown
        ...
        @selected_sald_bowl_1_next_monday = MealStatistic.retrieve("selected_sald_bowl_1_next_monday").to_i
        @selected_salad_bowl_2_next_monday = MealStatistic.retrieve("selected_salad_bowl_2_next_monday").to_i
        @selected_diet_next_monday = MealStatistic.retrieve("selected_diet_next_monday").to_i
        @selected_chefs_special_next_monday = MealStatistic.retrieve("selected_chefs_special_next_monday").to_i
        ...
        @selected_sald_bowl_1_next_thursday = MealStatistic.retrieve("selected_sald_bowl_1_next_thursday").to_i
        @selected_salad_bowl_2_next_thursday = MealStatistic.retrieve("selected_salad_bowl_2_next_thursday").to_i
        @selected_diet_next_thursday = MealStatistic.retrieve("selected_diet_next_thursday").to_i
        @selected_chefs_special_next_thursday = MealStatistic.retrieve("selected_chefs_special_next_thursday").to_i
