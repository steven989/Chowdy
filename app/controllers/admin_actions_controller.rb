    ...
    def delivery_csv
        ...
        @deliveries.each do |c|
            @data.push({
                ...
                reg_mon_check: c.meal_selections.where(production_day:production_day_1).blank? ? 0 : c.regular_meals_on_monday.to_i - (c.meal_selections.where(production_day:production_day_1).take.beef.to_i + c.meal_selections.where(production_day:production_day_1).take.pork.to_i + c.meal_selections.where(production_day:production_day_1).take.poultry.to_i),
                grn_mon_check: c.meal_selections.where(production_day:production_day_1).blank? ? 0 : c.green_meals_on_monday.to_i - (c.meal_selections.where(production_day:production_day_1).take.green_1.to_i + c.meal_selections.where(production_day:production_day_1).take.green_2.to_i),
