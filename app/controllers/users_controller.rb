class UsersController < ApplicationController
    ...
    def profile
        ...
        if @current_user.role == "admin"
            ...
            @cancel_curr_timeseries = @cancel_curr_timeseries[-14..-1].to_a

            @promotions = Promotion.all.order(created_at: :asc)

            @customer_column_names = Customer.columns.map {|c| c.name}

                #manually order key columns to the right
                @customer_column_names.push(@customer_column_names.delete("hub"))
                @customer_column_names.push(@customer_column_names.delete("gender"))
                @customer_column_names.push(@customer_column_names.delete("race"))
                @customer_column_names.push(@customer_column_names.delete("hub_note"))
                @customer_column_names.push(@customer_column_names.delete("purchase"))
                @customer_column_names.push(@customer_column_names.delete("number_of_plus"))
                @customer_column_names.push(@customer_column_names.delete("latest_chowdy_plus_bill_week"))
                @customer_column_names.push(@customer_column_names.delete("monday_regular_meal_count_override"))
                @customer_column_names.push(@customer_column_names.delete("thursday_regular_meal_count_override"))
                @customer_column_names.push(@customer_column_names.delete("monday_green_meal_count_override"))
                @customer_column_names.push(@customer_column_names.delete("thursday_green_meal_count_override"))
                @customer_column_names.push(@customer_column_names.delete("monday_plus_meal_count_override"))
                @customer_column_names.push(@customer_column_names.delete("thursday_plus_meal_count_override"))
                @customer_column_names.push(@customer_column_names.delete("plus_meals_on_monday"))
                @customer_column_names.push(@customer_column_names.delete("plus_meals_on_thursday"))
                @customer_column_names.push(@customer_column_names.delete("openmat_member?"))
                @customer_column_names.push(@customer_column_names.delete("one_time_fee_paid?"))
                @customer_column_names.push(@customer_column_names.delete("meal_preferences"))
                @customer_column_names.push(@customer_column_names.delete("last_surveyed"))
                @customer_column_names.push(@customer_column_names.delete("delivery_charge_accrued"))
                @customer_column_names.push(@customer_column_names.delete("delivery_charge_paid"))
                @customer_column_names.push(@customer_column_names.delete("raw_green_input"))
                @customer_column_names.push(@customer_column_names.delete("pause_cancel_request"))
                @customer_column_names.push(@customer_column_names.delete("cancellation_reason"))
                @customer_column_names.push(@customer_column_names.delete("referral_bonus_paid"))
                @customer_column_names.push(@customer_column_names.delete("updated_at"))
                @customer_column_names.push(@customer_column_names.delete("created_at"))
                @customer_column_names.push(@customer_column_names.delete("id"))

                #manually order key columns to the left
                @customer_column_names.unshift(@customer_column_names.delete("pause_end_date"))
                @customer_column_names.unshift(@customer_column_names.delete("special_delivery_instructions"))
                @customer_column_names.unshift(@customer_column_names.delete("delivery_address"))
                @customer_column_names.unshift(@customer_column_names.delete("phone_number"))
                @customer_column_names.unshift(@customer_column_names.delete("recurring_delivery"))
                @customer_column_names.unshift(@customer_column_names.delete("sponsored"))
                @customer_column_names.unshift(@customer_column_names.delete("matched_referrers_code"))
                @customer_column_names.unshift(@customer_column_names.delete("referral_code"))
                @customer_column_names.unshift(@customer_column_names.delete("referral"))
                @customer_column_names.unshift(@customer_column_names.delete("no_poultry"))
                @customer_column_names.unshift(@customer_column_names.delete("no_beef"))
                @customer_column_names.unshift(@customer_column_names.delete("no_pork"))
                @customer_column_names.unshift(@customer_column_names.delete("green_meals_on_thursday"))
                @customer_column_names.unshift(@customer_column_names.delete("green_meals_on_monday"))
                @customer_column_names.unshift(@customer_column_names.delete("regular_meals_on_thursday"))
                @customer_column_names.unshift(@customer_column_names.delete("regular_meals_on_monday"))
                @customer_column_names.unshift(@customer_column_names.delete("total_meals_per_week"))
                @customer_column_names.unshift(@customer_column_names.delete("thursday_delivery_hub"))
                @customer_column_names.unshift(@customer_column_names.delete("monday_delivery_hub"))
                @customer_column_names.unshift(@customer_column_names.delete("thursday_pickup_hub"))
                @customer_column_names.unshift(@customer_column_names.delete("monday_pickup_hub"))
                @customer_column_names.unshift(@customer_column_names.delete("next_pick_up_date"))
                @customer_column_names.unshift(@customer_column_names.delete("first_pick_up_date"))
                @customer_column_names.unshift(@customer_column_names.delete("recurring_delivery"))
                @customer_column_names.unshift(@customer_column_names.delete("paused?"))
                @customer_column_names.unshift(@customer_column_names.delete("active?"))
                @customer_column_names.unshift(@customer_column_names.delete("name"))
                @customer_column_names.unshift(@customer_column_names.delete("email"))
